...
async def main(prompt: str):
    ...
    print("-" * 60)
    print(
        "NOTE: Real-time token tracking (CpE) and Token Saturation Ratios (TSR) can be extracted automatically by attaching ADK's `BigQueryAgentAnalyticsPlugin` to the App object in agent.py."
    )
    print("=" * 60)
