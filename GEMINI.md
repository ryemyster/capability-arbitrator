# Coding Agent Guide (Capability Arbitrator Project)

This file outlines the rules, skills, and workflows that govern the AI coding agent's behavior in this workspace.
